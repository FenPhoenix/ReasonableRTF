...
•	THIRD: Just finalize the installation, double-click on the “installRTTUNN.bat” file to insure that everything is named properly and setup.
...
•	JohnnyTheWolf (French guy in the garden)
•	TheNightTerror (all the spectacular female logs!!)
•	Jonathan “Enchantermon” Duffer (TriOp level, shopping, BB)
•	TheRocketMan (guy who likes the lady bartender, repairman, killed by monkeys)
•	Lord Waffnuffly (repairman, Titus level)
•	Chris “Thiefsie Fool” (sick researcher, guy in maint. shaft)
•	Kolya (TriOp researcher, Deck 6 sly-guy)
•	Joel “Liquidfear” (guy in movie theater)
•	Yan Stofurst (one of the Many)

Additional thanks go to: 
•	Ben Forer for help with the Camvator
•	Ajare for his work on the audio log portraits
•	Patrick “Vurt” A. (awesome sound editing with the emails)
•	Yan Stofurst (log filter and editing expertise)

Skyboxes and Music:
•	Space skybox: Anachronox
•	TriOp skybox: Mighty Pete (www.petes-oasis.com)
•	Titus skybox: Woebane (http://brimstone.bromstone.com/quake2)
•	Garden bar music: Anachronox
•	All other music clips: Videohelper track
